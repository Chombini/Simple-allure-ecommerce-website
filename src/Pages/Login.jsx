    ...
    <div className='flex items-center justify-center min-h-screen bg-gray-100 px-6 md:px-0'>
      <div className='w-full max-w-md p-8 space-y-4 bg-white shadow-lg rounded-xl'>
        ...
        <form action="" className='space-y-6'>
          ...
          {/* submit button */}
          <button type='submit' className='w-full px-4 py-2 text-white bg-violet-700 rounded-lg hover:bg-violet-800 focus:outline-none focus:ring focus:ring-red-300'>Login</button>
        ...
        <div className='text-center'>
          <p className='text-sm text-gray-600'>
            ...
            <a href="#" className='text-violet-800 hover:underline'>Sign up</a>
          </p>
        </div>
      </div>
    </div>
