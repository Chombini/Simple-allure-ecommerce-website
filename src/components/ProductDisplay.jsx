  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 my-20 md:gap-10 px-6 md:px-0'>
      ...
      <div className='flex gap-5 font-semibold items-center my-5'>
        <div className='text-gray-500 text-2xl line-through'>{product.old_price}birr</div>
        <div className='text-violet-700 text-3xl'>{product.new_price}birr</div>
      </div>
      ...
      <Link to='/cart'>
       <button onClick={()=>addToCart(product.id)} className='bg-violet-700 text-white px-6 py-3 my-4 w-max'>ADD TO CART</button>
      </Link>
